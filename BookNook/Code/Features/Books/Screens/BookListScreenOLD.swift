...
//            VStack(spacing: 0) {
//                BookshelfViewOLD(category: .currentlyReading, height: bookshelfHeight(for: .currentlyReading, in: geometry), selectedBook: $selectedBook)
//                BookshelfViewOLD(category: .haveRead, height: bookshelfHeight(for: .haveRead, in: geometry), selectedBook: $selectedBook)
//                BookshelfViewOLD(category: .willRead, height: bookshelfHeight(for: .willRead, in: geometry), selectedBook: $selectedBook)
//            }
//        }
//    }
//
